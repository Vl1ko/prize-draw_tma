...
export default function BotInstructionPage2() {
  ...
  return (
    <AppRoot
      ...
      <Steps style={{ color: 'black' }} count={5} progress={2} />
        ...
        <Placeholder
          ...
          description={
            <Text style={{ color: '#FFFFFF' }} weight="3">
              Выберете необходимое количество Stars
            </Text>
          }
          header={
      ...
      <FixedLayout vertical="bottom">
        <div style={{ padding: '16px' }}>
          <Button
            style={{ color: '#007AFF' }}
            onClick={() => navigate('/starinstruction/bot/3')}
            id="NextButton"
            Component="a"
            mode="white"
            size="l"
