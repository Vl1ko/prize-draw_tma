...
export default function ServiceInstructionPage2() {
  ...
  return (
    <AppRoot
      ...
      <Steps style={{ color: 'black' }} count={3} progress={2} />
        ...
        <Placeholder
          ...
          description={
            <Text style={{ color: '#FFFFFF' }} weight="3">
              Если на вашем балансе не хватает звезд, выберете необходимое количество
            </Text>
          }
          header={
      ...
      <FixedLayout vertical="bottom" style={{ padding: '16px' }}>
        <Button
          style={{ color: '#007AFF' }}
          onClick={() => navigate('/starinstruction/service/3')}
          id="NextButton"
          Component="a"
          mode="white"
          size="l"
